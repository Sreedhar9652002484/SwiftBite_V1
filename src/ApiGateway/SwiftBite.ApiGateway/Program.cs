...
builder.Services.AddOpenIddict()
    .AddValidation(options =>
    {
        ...
        var gatewaySecret = builder.Configuration["OpenIddictClients:GatewaySecret"]
            ?? throw new InvalidOperationException("Missing required configuration: OpenIddictClients:GatewaySecret");

        options.UseIntrospection()
               .SetClientId("swiftbite-gateway")
               .SetClientSecret(gatewaySecret);
