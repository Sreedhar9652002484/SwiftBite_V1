...
builder.Services.AddOpenIddict()
    .AddValidation(options =>
    {
        ...
        var clientSecret = builder.Configuration["OpenIddictClients:UserServiceSecret"]
            ?? throw new InvalidOperationException("Missing required configuration: OpenIddictClients:UserServiceSecret");
