...
namespace SwiftBite.RestaurantService.Infrastructure.Caching;
...
public class RedisCacheService : ICacheService
{
    ...
    {
        // Redis doesn't natively support prefix delete
        // In production use Redis SCAN + DEL
        // For now just log it
        _logger.LogInformation(
            "🗑️ Cache REMOVE prefix: {Prefix}", prefix);
