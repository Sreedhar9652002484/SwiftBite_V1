...
builder.Services.AddOpenIddict()
    .AddValidation(options =>
    {
        ...
        var clientSecret = builder.Configuration["OpenIddictClients:DeliveryServiceSecret"]
            ?? throw new InvalidOperationException("Missing required configuration: OpenIddictClients:DeliveryServiceSecret");
...
builder.Services.AddHealthChecks()
    .AddSqlServer(
        builder.Configuration.GetConnectionString("DeliveryServiceDb"),
        name: "SwiftBite_DeliveryDb")
    .AddKafka(
        config => {
