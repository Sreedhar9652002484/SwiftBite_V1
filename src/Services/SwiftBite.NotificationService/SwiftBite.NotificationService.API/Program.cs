...
builder.Services.AddOpenIddict()
    .AddValidation(options =>
    {
        ...
        var clientSecret = builder.Configuration["OpenIddictClients:NotificationServiceSecret"]
            ?? throw new InvalidOperationException("Missing required configuration: OpenIddictClients:NotificationServiceSecret");
